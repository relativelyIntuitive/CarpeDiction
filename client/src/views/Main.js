...
const Main = props => {
    ...
    useEffect(() => {
        alert('* NOTICE:\n- The site will not currently work on Safari browsers...If you want that to change, consider tipping generously below so that I can buy a Mac to figure out why!\n- Enjoy!');
    }, [])
