                            ...
                            <div className="cdAbout">
                                <Typography>
                                    <strong>
                                        ...
                                        <br />
                                        <br />
                                        &emsp;&emsp;Any and all correspondence is both welcome and encouraged, so feel free to drop me a message at any of my linked profiles in the bottom right. I would love to hear about any issues, inspirations or ideas that you may encounter while browsing the site! Register to gain access to favorites and take part in the discussions! Query a word, phrase, suffix, prefix or colloquialism to get started, but be warned, for better or for worse, results are uncurated and may be offensive! Enjoy!
                                        <br />
                                        <br />
                                        &emsp;&ensp;- Zack
                                    </strong>
